...
abstract class AppStyles{
  ...
  static TextStyle mediumGray14Style = GoogleFonts.inter(fontSize: 14,fontWeight: FontWeight.w500,color: AppColors.black[30]);
  ...
  static TextStyle mediumPrimary20Style = GoogleFonts.inter(fontSize: 26,fontWeight: FontWeight.w500,color: AppColors.blue);
}