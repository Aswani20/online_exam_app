...
import 'package:online_exam_app/project_layers/api_layer/model/requests/change_pass_request_dto.dart';
...
import 'package:online_exam_app/project_layers/api_layer/model/responses/change_pass_response_dto.dart';
...
import '../model/responses/profile_response_dto.dart';
...
// Auth
  ...
  Future<HttpResponse<ProfileResponseDto>> getProfile();

  @PUT("/v1/auth/editProfile")
  Future<HttpResponse<ProfileResponseDto>> editProfile({
    @Body() required ProfileRequestDto request,
  });

  @PATCH("/v1/auth/changePassword")
  Future<HttpResponse<ChangePassResponseDto>> changePassword({
    @Body() required ChangePassRequestDto changePassRequest,
  });
}
