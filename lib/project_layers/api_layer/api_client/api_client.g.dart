...
class _ApiClient implements ApiClient {
  ...
  Future<HttpResponse<SigninResponseDto>> signin({
    ...
    final _data = <String, dynamic>{};
    _data.addAll(request.toJson());
    final _options = _setStreamType<HttpResponse<SigninResponseDto>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/auth/signin',
  ...
  Future<HttpResponse<ForgetPassResponseDto>> forgetPass({
    required ForgetPassRequestDto forgetPassRequest,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    final _options = _setStreamType<HttpResponse<ForgetPassResponseDto>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ForgetPassResponseDto _value;
    try {
      _value = ForgetPassResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<HttpResponse<OtpResponseDto>> otpVerify({
    required OtpRequestDto otpRequest,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    final _options = _setStreamType<HttpResponse<OtpResponseDto>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<HttpResponse<ResetPassResponseDto>> resetPass({
    required ResetPassRequestDto resetPassRequest,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    final _options = _setStreamType<HttpResponse<ResetPassResponseDto>>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ResetPassResponseDto _value;
    try {
      _value = ResetPassResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<HttpResponse<ProfileResponseDto>> getProfile() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<ProfileResponseDto>>(
  ...
  @override
  Future<HttpResponse<ProfileResponseDto>> editProfile({
    required ProfileRequestDto request,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
